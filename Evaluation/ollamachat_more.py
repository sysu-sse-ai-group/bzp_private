...
if __name__ == "__main__":
    ...
    inputs = []
    # 打开并读取JSON文件
    # {'dol': 'dolphin-phi'}, {'ge_2': 'gemma:2b'} {'ge_7': 'gemma:7b'},{'llama_13': 'llama2:13b'}, {'llama_2': 'llama2:7b'}, {'llava': 'llava'}, {'mistral': 'mistral'}, }
    model_list=[{'dol': 'dolphin-phi'}, {'ge_2': 'gemma:2b'}, {'ge_7': 'gemma:7b'},{'llama_13': 'llama2:13b'}, {'llama_2': 'llama2:7b'}, {'llava': 'llava'}, {'mistral': 'mistral'},{'openchat': 'openchat'}, {'qwen': 'qwen'}]
